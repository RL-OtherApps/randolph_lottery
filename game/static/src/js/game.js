...
function gameOver(){
  ...
  document.getElementById("totaldistance").innerText ="You have covered "+  fieldDistance.textContent;
  var criteria=document.getElementById("dist_crit").innerText
  if (parseInt(criteria) <= parseInt(fieldDistance.textContent))
    document.getElementById("result_message").innerText = "You have won the game"
  else if (parseInt(criteria) > parseInt(fieldDistance.textContent)){
    document.getElementById("result_message").innerText = "Sorry!! You have lost the game";
  }
